...
<?php include("header.php"); ?>
   <div class="container">
       <div class="form-group">
           <form method="post" action="regAction1.php">
              <table cellpadding="10" colspacing="10" width="1000" align="center" id="tab">
               ...
               <tr>
                   <td>Emergency number1</td>
                   <td><input type="number" class="form-control" name="e1"></td>
                   <td>Emergency number2</td>
                   <td><input type="number" class="form-control" name="e2"></td>
               </tr>
